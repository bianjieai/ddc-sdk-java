...
import ai.bianjie.ddc.serviceforpl.*;

public class DDCSdkClientForPL {
     ...
     * SDK 初始化方法
     */
    private DDCSdkClientForPL(Builder builder) {
    ...
    public static class Builder {
        ...
        public DDCSdkClientForPL init() {
            ...
            return new DDCSdkClientForPL(this);
        }
    }
     ...
     * @return 返回权限管理服务的实例
     */
    public ai.bianjie.ddc.serviceforpl.AuthorityService getAuthorityService() {
     ...
     * @return 返回费用管理服务的实例
     */
    public ai.bianjie.ddc.serviceforpl.ChargeService getChargeService() {
     ...
     */
    public ai.bianjie.ddc.serviceforpl.DDC1155Service getDDC1155Service() {
     ...
     */
    public ai.bianjie.ddc.serviceforpl.DDC721Service getDDC721Service() {
