...
//        TransactionReceipt re7au = ddc721data.setAuthorityLogicAddress("0x368d4064762a22640E8a79cA6B62F0815f3e2F9C");
//        System.out.println("--------------------------------------"+re7au.toString()+"------------");
//        TransactionReceipt re7ch = ddc721data.setChargeLogic("0xcA65BAbCB23053B0b1Fb3bB2d79E487e56e1FBC4");
//        System.out.println("--------------------------------------"+re7ch.toString()+"------------");
//
...
//        TransactionReceipt re1155au = ddc1155data.setAuthorityLogicAddress("0x368d4064762a22640E8a79cA6B62F0815f3e2F9C");
//        System.out.println("--------------------------------------"+re1155au.toString()+"------------");
//        TransactionReceipt re1155ch = ddc1155data.setChargeLogic("0xcA65BAbCB23053B0b1Fb3bB2d79E487e56e1FBC4");
//        System.out.println("--------------------------------------"+re1155ch.toString()+"------------");
...
//      String h = authorityService.hasper("918F7F275A6C2D158E5B76F769D3F1678958A334",ConfigCache.get().getDdc721Address(),DDC721.FUNC_MINT.getBytes())    ;
      String hash = dd.mint("07B7BE76ED588CCEFB4C4A573CB28A7D2A1403CC","111111")     ;
      System.out.println("--------------------------------------" + hash + "------------");
//
    }
}