...
//        client.setGatewayApiValue("5823d69e2198453e8662758e11cadacb");
    ...
    void setFee() throws Exception {
        client.setGatewayUrl("http://192.168.150.42:8545");
        String hash = chargeService.setFee(sender, "0x510B0210fF2e3820B0662F7888b97E316c3d9034", "0xe985e9c5", new BigInteger("1000"));
        System.out.print(hash);
    }
    ...
    void delFee() throws Exception {
        client.setGatewayUrl("http://192.168.150.42:8545");
        String hash = chargeService.delFee(sender, "0x510B0210fF2e3820B0662F7888b97E316c3d9034", "0xe985e9c5");
        System.out.print(hash);
    }
    ...
    void delDDC() throws Exception {
        client.setGatewayUrl("http://192.168.150.42:8545");
        String hash = chargeService.delDDC(sender, "0x510B0210fF2e3820B0662F7888b97E316c3d9034");
        System.out.print(hash);
    }
