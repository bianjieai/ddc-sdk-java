package ai.bianjie.ddc.util.secp256k1;

import ai.bianjie.ddc.util.sm2.BCECUtils;
import ai.bianjie.ddc.util.sm2.GMBaseUtils;
import ai.bianjie.ddc.util.sm2.SM2Cipher;
...
public class SecP256K1 extends GMBaseUtils {
    ...
    public final static BigInteger SecP256K1_ECC_A = CURVE.getA().toBigInteger();
    public final static BigInteger SecP256K1_ECC_B = CURVE.getB().toBigInteger();
    public final static BigInteger SecP256K1_ECC_N = CURVE.getOrder();
    public final static BigInteger SecP256K1_ECC_H = CURVE.getCofactor();
    public final static BigInteger SecP256K1_ECC_GX = new BigInteger(
            "79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798", 16);
    public final static BigInteger SecP256K1_ECC_GY = new BigInteger(
    ...
    public static final EllipticCurve JDK_CURVE = new EllipticCurve(new ECFieldFp(SecP256K1_ECC_P), SecP256K1_ECC_A, SecP256K1_ECC_B);
    ...
    public static final java.security.spec.ECParameterSpec JDK_EC_SPEC = new java.security.spec.ECParameterSpec(
            JDK_CURVE, JDK_G_POINT, SecP256K1_ECC_N, SecP256K1_ECC_H.intValue());
