...
import ai.bianjie.ddc.client.ListenChainUtil;
import ai.bianjie.ddc.constant.AttributeKey;
import ai.bianjie.ddc.constant.EventType;
import ai.bianjie.ddc.exception.IritaSDKException;
import ai.bianjie.ddc.function.InvokeCallback;
import ai.bianjie.ddc.function.RespondCallback;
import ai.bianjie.ddc.model.*;
import ai.bianjie.ddc.model.tx.Condition;
import ai.bianjie.ddc.model.tx.EventQueryBuilder;
import ai.bianjie.ddc.util.AddressUtils;
import ai.bianjie.ddc.util.JsonUtils;
import ai.bianjie.ddc.util.LogUtils;
...
public class ServiceClient {
    ...
    public void subscribeServiceResponse(String reqCtxID, InvokeCallback callback) {
        ...
        baseClient.getRpcClient().subscribeTx(builder, tx -> {
            ai.bianjie.ddc.model.ws.tx.Events events = tx.getResult().getEvents();
