...
public class DDC721Service extends BaseService {
     ...
     * The contract owner calls this method to set the name and symbol of 721.
     *
     * @param sender Caller address
     * @param name   DDC Unique Identifier
     * @param symbol DDC resource identifier
     * @return hash, Transaction hash
     * @throws Exception Exception
     */
    public String setNameAndSymbol(String sender, String name, String symbol) throws Exception {
        ...
        String encodedFunction = ddc721.setNameAndSymbol(name, symbol).encodeFunctionCall();
        return signAndSend(ddc721, DDC721.FUNC_SETNAMEANDSYMBOL, encodedFunction, signEventListener, sender).getTransactionHash();
    }
